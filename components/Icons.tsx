...
export const LogoShape = ({ color }: { color: string }) => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 5V35" stroke={color} strokeWidth="3" strokeLinecap="round"/>
    <path d="M16 10V30" stroke={color} strokeWidth="3" strokeLinecap="round"/>
    <path d="M22 2V38" stroke={color} strokeWidth="3" strokeLinecap="round"/>
    <path d="M28 12V28" stroke={color} strokeWidth="3" strokeLinecap="round"/>
  </svg>
);

export const HandSwipe = ({ color }: { color: string }) => (
   <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M17 15L12 10L7 15" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M12 20V11" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
   </svg>
);